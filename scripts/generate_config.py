...
def main(args):
    ...
    write_bash(k=args.k, preprocess=True)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generage configeration using random search.")
    parser.add_argument("--k", default=100, dest="k", type=int, help="Number of models")
    ...
    parser.add_argument("--output_name", "-n", dest="output_name", default="config.ini")
